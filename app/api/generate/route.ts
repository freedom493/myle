...
export async function POST(req: Request) {
  try {
    ...
    const prompt = isFlashcard
      ? 'Analyze this document thoroughly and extract the most important concepts, terms, definitions, and principles to create comprehensive study flashcards. Each flashcard should have a clear, concise term and a detailed, exam-ready definition. Generate at least 15 - 30 flashcards covering all major topics.'
